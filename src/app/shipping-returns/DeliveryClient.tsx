      ...
      <div className="container mx-auto px-4 md:px-8 max-w-3xl">
        ...
        <div className="space-y-16">
          ...
          {initialData?.content ? (
            ...
            <>
              <motion.section initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                <h2 className="font-serif text-2xl text-foreground mb-6 border-b border-foreground/10 pb-4">Shipping Methods & Costs</h2>
                <div className="space-y-6 text-gray-600 font-light leading-relaxed text-sm">
                  ...
                  <div className="bg-secondary p-6 rounded-[2rem]">
                    <h3 className="font-medium text-foreground uppercase tracking-[0.1em] text-xs mb-4">Domestic (India)</h3>
                    <ul className="space-y-4">
                      <li className="flex justify-between items-center border-b border-foreground/5 pb-2">
                  ...
                  <div className="bg-secondary p-6 rounded-[2rem]">
                    <h3 className="font-medium text-foreground uppercase tracking-[0.1em] text-xs mb-4">International</h3>
                    <ul className="space-y-4">
                      <li className="flex justify-between items-center border-b border-foreground/5 pb-2">
              ...
              <motion.section initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                <h2 className="font-serif text-2xl text-foreground mb-6 border-b border-foreground/10 pb-4">Order Tracking</h2>
                <div className="prose prose-sm text-gray-600 font-light leading-relaxed">
                  <p>
              ...
              <motion.section initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
                <h2 className="font-serif text-2xl text-foreground mb-6 border-b border-foreground/10 pb-4">No Returns — Every Order Is Final</h2>
                <div className="prose prose-sm text-gray-600 font-light leading-relaxed">
                  <p>
                  ...
                  <h3 className="text-foreground font-medium mt-8 mb-2 border-l-2 border-black pl-4">Mandatory Unboxing Video</h3>
                  <div className="bg-secondary p-6 rounded-[1rem] mt-4">
                    <p className="mb-4 text-foreground font-medium">To process any claims for transit damage, missing items, or incorrect products, an unboxing video is strictly mandatory.</p>
        ...
        <div className="mt-20 flex justify-center border-t border-foreground/10 pt-12">
          <Link href="/shop" className="inline-flex items-center gap-4 uppercase tracking-[0.1em] text-xs font-medium text-foreground group border-b border-black pb-3">
            Continue Shopping
